...
//when we push code to github, there is no need to push the node_modules folder which will take up a lot of space.
//instead if we just puch the .json with dependencies, we just need to run npm install command to get all the dependencies.


const _ = require('lodash') //for lodash, _ is a common way to use
